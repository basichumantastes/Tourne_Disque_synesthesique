...
class OSCRouter:
    def __init__(self):
        ...
        self.routes = {
            ...
            "/vision/": ["logic", "led", "dev", "puredata", "arduino_serial"],     # Messages vision vers logic, led, Arduino et dev
            "/logic/": ["led", "puredata", "music_engine", "dev", "arduino_serial"],  # Messages logic vers LED, PD, music engine, Arduino et dev
