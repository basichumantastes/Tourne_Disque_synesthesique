...
REMOTE_PATH="/home/blanchard/color_detection_project"
...
# Redémarrage du service supervisor si nécessaire
log "Redémarrage du service..."
ssh ${REMOTE_USER}@${REMOTE_HOST} "sudo systemctl restart supervisor"
